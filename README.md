...
* `main_analysis.ipynb`: The primary research notebook containing the full pipeline.
* `Executive_Summary.csv`: High-level metrics for 20 optimized trade lanes.
* `Optimization_Report.txt`: A formatted executive report generated by the engine.
* `Optimization_Results_Summary.png`: Comparative visualization of strategy performance.
